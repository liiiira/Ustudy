...
export default function ImageField({
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className={`relative overflow-hidden border-2 border-gray-300 bg-gray-100 ${VARIANTS[variant]}`}>
      ...
      <div className="flex flex-row gap-2">
        {value &&
          <Button type="button" variant="Primary" disabled={uploading} onClick={() => setViewOpen(true)}>
            View
          </Button>
        }
      ...
      <Modal open={viewOpen} onClose={() => setViewOpen(false)} title={label}>
        {value && <img src={value} alt="" className="max-h-[80vh] max-w-[90vw] object-contain rounded-md" />}
      </Modal>
