...
export default function LoginForm() {
  ...
  const [inputError, setInputError] = useState<LoginError>({
    email: [],
    password: [],
  });
  ...
  function validateUser(user: LoginUser): boolean {
    const passwordErrors: string[] = validateLength(
      "Password",
      user.password,
      8,
      24,
    ...
    return ![passwordErrors, emailErrors].some(
  ...
  return (
    <form
      className=" p-6 w-1/2 h-max max-w-md flex flex-col content-between border-2 gap-5 border-gray-300 rounded-2xl bg-white"
    ...
    >
      <div id="form-header" className="flex flex-col gap-1">
        ...
        <div className="text-md font-light text-gray-600 text-center w-full mb-2">
