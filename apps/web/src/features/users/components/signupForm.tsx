...
export default function SignupForm(){
  ...
  return (
    <form className="mx-auto my-auto p-2 w-1/2 h-1/2 flex flex-col gap-4 border-2 border-gray-400 rounded-2xl" 
      onSubmit={handleSubmit}>

    <p>Sign up form</p>

    <input className="bg-white px-4 py-2 border-2 border-gray-300" 
