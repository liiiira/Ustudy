...
| Primary datastore | PostgreSQL | ACID-compliant relational store; the domain (users, communities, posts, comments) is inherently relational, and foreign keys enforce referential integrity that a document store would push into application code |
